...
#ifndef LookUpQueue_hpp
#define LookUpQueue_hpp
...
public:
   ...
   virtual bool isIdle() {return _isIdle;}
    ...
    virtual Queue* getQueue() {return _queue;}
      ...
      virtual std::string nameOfQueue() {return "LookUpQueue";}
