...
#ifndef PickUpQueue_hpp
#define PickUpQueue_hpp
...
public:
   ...
   virtual bool isIdle() {return _isIdle;}
    ...
    virtual Queue* getQueue() {return _queue;}
      ...
      virtual std::string nameOfQueue() {return "PickUpQueue";}
