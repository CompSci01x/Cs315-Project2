...
#ifndef SameTrackQueue_hpp
#define SameTrackQueue_hpp
...
public:
   ...
   virtual bool isIdle() {return _isIdle; }
    ...
    virtual Queue* getQueue() {return _queue;}
      ...
      virtual std::string nameOfQueue() {return "SameTrackQueue";}
